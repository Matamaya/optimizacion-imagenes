...
const TestEjercicio3 = () => {
    ...
    return (
        <div className="p-8 bg-card rounded-2xl shadow-xl mt-12 border border-gray-100 dark:border-gray-800 transition-all">
            <h2 className="text-3xl font-extrabold mb-6 bg-gradient-to-r from-orange-600 to-yellow-500 bg-clip-text text-transparent">
                ...
                {questions.map((q, i) => (
                    <div key={i} className="group">
                        <p className="text-lg font-bold mb-3 text-gray-800 dark:text-gray-200">
                            <span className="mr-2 text-orange-500 font-black">0{i + 1}.</span>
                            {q.question}
                        </p>
